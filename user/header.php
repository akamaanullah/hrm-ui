            ...
            <header class="topbar">
                ...
                <div class="topbar-right">
                    <div class="topbar-actions">
                        <div class="dropdown attendance-action-dropdown">
                            <button class="btn btn-light attendance-action-toggle" type="button" id="attendanceActionDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="bi bi-clock-history"></i>
                                <span>Attendance Action</span>
                            </button>
                            <ul class="dropdown-menu dropdown-menu-end attendance-action-menu" aria-labelledby="attendanceActionDropdown">
                                <li>
                                    <a class="dropdown-item attendance-action-item" href="#" data-action="clock-in">
                                        <i class="bi bi-box-arrow-in-right"></i>
                                        <span>Clock In</span>
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item attendance-action-item" href="#" data-action="clock-out">
