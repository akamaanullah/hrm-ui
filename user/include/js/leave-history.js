// ===== LEAVE HISTORY TABLE WITH DATATABLES =====
    ...
    var table = $('#leaveHistoryTable').DataTable({
        ...
        drawCallback: function() {
            ...
            $('.badge').each(function() {
                ...
                $(this).removeClass('badge-approved badge-pending badge-rejected');
                if (status === 'approved') {
                    $(this).addClass('badge-approved');
                } else if (status === 'pending') {
                    $(this).addClass('badge-pending');
                } else if (status === 'rejected') {
                    $(this).addClass('badge-rejected');
                }
            });
...
function combinePaginationInfo() {
    setTimeout(function() {
        var infoElement = $('#leaveHistoryTable_info');
        var paginateElement = $('#leaveHistoryTable_paginate');
        var wrapper = $('#leaveHistoryTable').closest('.dataTables_wrapper');
